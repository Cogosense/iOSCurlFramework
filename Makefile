...
$(DERIVED_FILE_DIR)/$(ARM_V7_ARCH)/$(INSTALLED_BUILD_LIB) : AC_HOST = $(ARM_V7_HOST)
$(DERIVED_FILE_DIR)/$(ARM_V7_ARCH)/$(INSTALLED_BUILD_LIB) : AC_SDK = iphoneos
$(DERIVED_FILE_DIR)/$(ARM_V7_ARCH)/$(INSTALLED_BUILD_LIB) : AC_C_ARCH = -arch $(ARM_V7_ARCH)
$(DERIVED_FILE_DIR)/$(ARM_V7_ARCH)/$(INSTALLED_BUILD_LIB) : AC_CPP_ARCH = -arch arm
$(DERIVED_FILE_DIR)/$(ARM_V7_ARCH)/$(INSTALLED_BUILD_LIB) : $(DERIVED_FILE_DIR)/$(ARM_V7_ARCH) $(DERIVED_FILE_DIR)/$(ARM_V7_ARCH)/Makefile
	$(MAKE) -C $(DERIVED_FILE_DIR)/$(ARM_V7_ARCH) DESTDIR=$(DERIVED_FILE_DIR)/$(ARM_V7_ARCH) install

$(DERIVED_FILE_DIR)/$(ARM_V7S_ARCH)/$(INSTALLED_BUILD_LIB) : AC_HOST = $(ARM_V7S_HOST)
$(DERIVED_FILE_DIR)/$(ARM_V7S_ARCH)/$(INSTALLED_BUILD_LIB) : AC_SDK = iphoneos
$(DERIVED_FILE_DIR)/$(ARM_V7S_ARCH)/$(INSTALLED_BUILD_LIB) : AC_C_ARCH = -arch $(ARM_V7S_ARCH)
$(DERIVED_FILE_DIR)/$(ARM_V7S_ARCH)/$(INSTALLED_BUILD_LIB) : AC_CPP_ARCH = -arch arm
$(DERIVED_FILE_DIR)/$(ARM_V7S_ARCH)/$(INSTALLED_BUILD_LIB) : $(DERIVED_FILE_DIR)/$(ARM_V7S_ARCH) $(DERIVED_FILE_DIR)/$(ARM_V7S_ARCH)/Makefile
	$(MAKE) -C $(DERIVED_FILE_DIR)/$(ARM_V7S_ARCH) DESTDIR=$(DERIVED_FILE_DIR)/$(ARM_V7S_ARCH) install

$(DERIVED_FILE_DIR)/$(ARM_64_ARCH)/$(INSTALLED_BUILD_LIB) : AC_HOST = $(ARM_64_HOST)
$(DERIVED_FILE_DIR)/$(ARM_64_ARCH)/$(INSTALLED_BUILD_LIB) : AC_SDK = iphoneos
$(DERIVED_FILE_DIR)/$(ARM_64_ARCH)/$(INSTALLED_BUILD_LIB) : AC_C_ARCH = -arch $(ARM_64_ARCH)
$(DERIVED_FILE_DIR)/$(ARM_64_ARCH)/$(INSTALLED_BUILD_LIB) : AC_CPP_ARCH = -arch arm
$(DERIVED_FILE_DIR)/$(ARM_64_ARCH)/$(INSTALLED_BUILD_LIB) : $(DERIVED_FILE_DIR)/$(ARM_64_ARCH) $(DERIVED_FILE_DIR)/$(ARM_64_ARCH)/Makefile
	$(MAKE) -C $(DERIVED_FILE_DIR)/$(ARM_64_ARCH) DESTDIR=$(DERIVED_FILE_DIR)/$(ARM_64_ARCH) install

$(DERIVED_FILE_DIR)/$(I386_ARCH)/$(INSTALLED_BUILD_LIB) : AC_HOST = $(I386_HOST)
$(DERIVED_FILE_DIR)/$(I386_ARCH)/$(INSTALLED_BUILD_LIB) : AC_SDK = iphonesimulator
$(DERIVED_FILE_DIR)/$(I386_ARCH)/$(INSTALLED_BUILD_LIB) : AC_C_ARCH = -arch $(I386_ARCH)
$(DERIVED_FILE_DIR)/$(I386_ARCH)/$(INSTALLED_BUILD_LIB) : AC_CPP_ARCH = -arch $(I386_ARCH)
$(DERIVED_FILE_DIR)/$(I386_ARCH)/$(INSTALLED_BUILD_LIB) : $(DERIVED_FILE_DIR)/$(I386_ARCH) $(DERIVED_FILE_DIR)/$(I386_ARCH)/Makefile
	$(MAKE) -C $(DERIVED_FILE_DIR)/$(I386_ARCH) DESTDIR=$(DERIVED_FILE_DIR)/$(I386_ARCH) install

$(DERIVED_FILE_DIR)/$(X86_64_ARCH)/$(INSTALLED_BUILD_LIB) : AC_HOST = $(X86_64_HOST)
$(DERIVED_FILE_DIR)/$(X86_64_ARCH)/$(INSTALLED_BUILD_LIB) : AC_SDK = iphonesimulator
$(DERIVED_FILE_DIR)/$(X86_64_ARCH)/$(INSTALLED_BUILD_LIB) : AC_C_ARCH = -arch $(X86_64_ARCH)
$(DERIVED_FILE_DIR)/$(X86_64_ARCH)/$(INSTALLED_BUILD_LIB) : AC_CPP_ARCH = -arch $(I386_ARCH)
$(DERIVED_FILE_DIR)/$(X86_64_ARCH)/$(INSTALLED_BUILD_LIB) : $(DERIVED_FILE_DIR)/$(X86_64_ARCH) $(DERIVED_FILE_DIR)/$(X86_64_ARCH)/Makefile
...
bundle-headers : bundle-dirs
	cp -R $(DERIVED_FILE_DIR)/$(FIRST_ARCH)/$(FRAMEWORKBUNDLE)/include/curl/ $(BUILT_PRODUCTS_DIR)/$(FRAMEWORKBUNDLE)/Versions/$(FRAMEWORK_VERSION)/Headers/
	$(RM) $(BUILT_PRODUCTS_DIR)/$(FRAMEWORKBUNDLE)/Versions/$(FRAMEWORK_VERSION)/Headers/curlbuild.h
	for arch in $(ARCHS) ; do \
	    cp $(DERIVED_FILE_DIR)/$${arch}/$(FRAMEWORKBUNDLE)/include/curl/curlbuild.h $(BUILT_PRODUCTS_DIR)/$(FRAMEWORKBUNDLE)/Versions/$(FRAMEWORK_VERSION)/Headers/curlbuild_$${arch}.h ; \
	done
